...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_f4uoeo93jjgwebec.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_f4uoeo93jjgwebec.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_f4uoeo93jjgwebec.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_f4uoeo93jjgwebec.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_f4uoeo93jjgwebec.getAutoResizeBottomMargin(editor);
    ...
    if ($_f4uoeo93jjgwebec.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_7bkzfk90jjgwebe8.resize(editor, oldSize);
    });
  };
  var $_806tt38zjjgwebe6 = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_806tt38zjjgwebe6.register(editor, oldSize);
      $_7bkzfk90jjgwebe8.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
